...
function addParagraph() {
    ...
    const pContent = 'this is a random number ' + randomNum;
...
function showJoke() {
  ...
  const para = document.querySelector('.joke-content');
...
function showQuote() {
  ...
  const megha = document.querySelector('.quote-content');
  ...
  author.textContent = '-' + randomQuote.author;
   clearAll();
   megha.appendChild(quote);
   megha.appendChild(author);
...
function showRiddle() {
  ...
  const randomRiddle = getRandomData('riddles');
   ...
   answerElem.hidden = true; //answwer hide kora hocche.

   const reshmi = document.querySelector('.riddle-content');
   clearAll();
   
reshmi.appendChild(questionElem);
reshmi.appendChild(answerElem);
}
...
function revealAnswers() {
  ...
  if(riddle && answer.hidden) {
    answer.hidden = false; // jodi riddle thake and answer jodi hidden thake seta jate  unhidden hoy
  } else if(riddle){
    alert('already answer dewa achhe :p ')
  } else {
alert('kono riddle select kora hoyni')
  }
